...
//   };
   const handleLogout = () => {
    ...
    setCurrentUserData(""); // Clear the current user data state
    props.setIsLoggedIn(false); // Set the isLoggedIn state to false
  
    // Redirect to the login page or any desired route
    navigate("/"); // Assuming "/" is the route for login page
  };
